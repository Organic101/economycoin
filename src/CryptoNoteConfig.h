...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x75e0; // addresses start with "ec"
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(183369486260);
...
const char     CRYPTONOTE_NAME[]                             = "Economycoin";
